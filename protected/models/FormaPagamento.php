 ...
 *
 * The followings are the available columns in table 'forma_pagamento':
 * @property integer $id
...
class FormaPagamento extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, nome, ativo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
            ...
            return array(
                'pedidos' => array(self::HAS_MANY, 'Pedido', 'forma_pagamento_id'),
            );
	}
