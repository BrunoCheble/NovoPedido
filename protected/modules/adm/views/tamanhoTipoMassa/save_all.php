...
<script>
    $(document).ready(function() {
        $("[name='TamanhoTipoMassa[preco][]']").maskMoney({decimal: ",", thousands: "."});
...
<form method="post" class="">
    <div class="row-fluid">
                ...
                <div class="widget-content">
                    <div class="padd">
                        ...
                        foreach ($arrayTamanho as $key => $tamanho) {
                            ...
                            echo CHtml::hiddenField('TamanhoTipoMassa[tamanho_id][]', $key);
                            echo '<div class="input-prepend"><span class="add-on">R$ </span>' . CHtml::textField('TamanhoTipoMassa[preco][]', '', array('class' => 'span9')) . "</div>";
                            echo '</div>';
                            echo '</div>';
                        }
                        ?>
        ...
        <div class="span9">
            <div class="widget">
                <!-- Widget title -->
                <div class="widget-head">Cardápio atual de tipos de massas</div>
                <div class="widget-content">
                    <div class="padd">
                        <table class="items table table-striped table-bordered table-condensed">
                            ...
                            <tbody>
                                ...
                                foreach ($modelItens as $item) {
                                    echo '<tr>';
                                    echo '<td><input name="TamanhoTipoMassa[tipo_massa_id][]" type="checkbox" value="' . $item->id . '" /></td>';
                                    echo '<td>' . $item->descricao . '</td>';

                                    foreach ($arrayTamanho as $key_tamanho => $tamanho) {
                                        $html[$key_tamanho] = "<td></td>";
                                        foreach ($item->tamanhoTipoMassas as $tamanhoItem) {
